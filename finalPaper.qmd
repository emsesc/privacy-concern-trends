...
***Figure 4.*** Map of Average Library Usage Index by DMA
...
***Figure 5.*** Average Revenue Difference (2021-2019) vs. Total Book Bans Count
...
***Table 1:*** Regression Results of Model 1a
...
***Figure 6.*** Map of Average Library Revenue in 2021 by DMA
...
***Table 2:*** Regression Results of Model 1b
...
***Figure 7.*** Average Search Hit Difference (Next Month - Previous Month) vs. Book Bans Count
...
plot(hits_combined_df$count, hits_combined_df$diff, 
     ...
     xlab = "Bans Count",
     ylab = "Average Search Hit Difference\n(Next Month - Previous Month)",
     pch = 19, col = "blue")
...
***Figure 8.*** Average Usage Index Difference (2021 - 2019) vs. Total Book Bans Count
...
***Table 5:*** Regression Results of Model 2c
