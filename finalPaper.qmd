...
Future research should expand beyond 2019-2021 because there are a couple factors that restrict this study for making a valid conclusion that book bans have little to no impact on library usage and funding. As COVID heavily impacted libraries in 2020, they were still attempting to recover during 2021, so any observed effects may also have the pandemic as a confounding factor. Additionally, even though book bans gained traction in 2021, 2023 was the year when the number of these events peaked and would have caused the most disruption in public library operations. Most events covered in news articles about library staff resigning and funding cuts occur towards the end of 2023.

Evaluating library usage as one index is another limitation of this study. For example, it is possible the rate of circulation remained the same but the distribution of specific books, such as the ones that were banned, may have increased. Other variables of interest that could be considered in future studies is the financial burden of book ban processing on libraries and if they are significant enough that they deter the quality of libraries. This study also only considers school library book bans as it was restricted by the bans documented in the PEN America's Index; different results could be yielded with a dataset that also includes bans and challenges at public community libraries. Future research considering these additional variables and expanding the timeframe of analysis could extend on the validity of these conclusions.
